            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                    @foreach ($slotOccurences->sortBy(function($slotOccurence) {
                        ...
                        @php
                            // Vérifier si l'utilisateur est déjà inscrit pour cette occurrence
                        ...
                        <div class="relative bg-[#FEFFFF] text-[#17252A] p-6 rounded-lg shadow-md transition transform hover:scale-105 hover:shadow-lg">
                            ...
                            @if ($slotOccurence->is_cancelled)
                                <!-- Affichage de l'annulation avec la raison fournie -->
                            ...
                            @else
                                ...
                                @else
                                    ...
                                    @if ((Auth::user()->role == 'monitor' || Auth::user()->role == 'admin-club') && !$isRegisteredAsMonitor && !$isRegisteredAsMember)
